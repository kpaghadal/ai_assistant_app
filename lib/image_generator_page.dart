        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text('Image Generator', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
              ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Prompt', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 10),
                    TextField(
                      controller: _prompt,
                      maxLines: 3,
                      decoration: roundedInputDecoration(
                        hint: 'Describe your image idea here...\ne.g. A futuristic city with flying cars',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Generate Image', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
                ),
              ),
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: const [
                            Icon(Icons.image_outlined, size: 64, color: AppColors.textMuted),
                            SizedBox(height: 8),
                            Text('Generated image will appear here', style: TextStyle(color: AppColors.textMuted)),
                          ],
                        ),
                      ),
                    ),
